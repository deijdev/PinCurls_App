...
p1 = Post.create(title: "curl"
    , content: "conditioning", user: beza,  img: "https://res.cloudinary.com/drpyvuhac/image/upload/v1587048890/easy-african-american-weaving-hairstyles_exqwor.jpg" )
